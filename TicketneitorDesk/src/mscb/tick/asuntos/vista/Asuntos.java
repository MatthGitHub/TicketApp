 ...
 */
public class Asuntos extends MenuP {
    Main mainFrame;
    private static Asuntos asuntos;
    private AsuntoPrincipalServ serviciosA;
    private static List<AsuntoPrincipal> misAsuntos;
    ...
    private Asuntos(Main mainFrame) {
        initComponents();
    ...
    public static Asuntos getAsuntos(Main mainFrame){
        if(asuntos == null){
            asuntos = new Asuntos(mainFrame);
        }
        return asuntos;
    }
    
    private List<AsuntoPrincipal> traerAsuntos(){
