 ...
 */
public class NuevoAsuntoFrame extends javax.swing.JFrame {
    Main mainFrame;
     ...
     */
    public NuevoAsuntoFrame(Main mainFrame) {
        initComponents();
    ...
    private NuevoAsuntoFrame() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
    public void nuevoAsunto(){
        nuevoAsunto = NuevoAsunto.getNuevoAsunto(this,mainFrame);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoAsuntoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoAsuntoFrame().setVisible(true);
            }
        });
    }
