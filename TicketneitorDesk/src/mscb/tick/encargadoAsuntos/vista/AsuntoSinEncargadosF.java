 ...
 */
public class AsuntoSinEncargadosF extends javax.swing.JFrame {
    Main mainFrame;
    private int x;
    private int y;
     ...
     */
    public AsuntoSinEncargadosF(Main mainFrame) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsuntoSinEncargadosF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AsuntoSinEncargadosF().setVisible(true);
            }
        });
    }
