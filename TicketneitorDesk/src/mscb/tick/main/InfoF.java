 ...
 */
public class InfoF extends javax.swing.JFrame {
    Main mainFrame;
    ...
    public Image getIconImage() {
        Image retValue = Toolkit.getDefaultToolkit().
                getImage(ClassLoader.getSystemResource("mscb/tick/imagenes/info.png"));
    ...
    /**
     * Creates new form InfoF
     */
    public InfoF(Main mainFrame) {
        initComponents();
        setTitle("Acerca de ...");
        setSize(230, 260);
        setVisible(true);
    ...
    public void panelInfoP(){
        miPanel = InfoP.getInfoP(this);
    ...
    public void informacionSistemaM(){
        suPanel = InformacionSistema.getInformacionSistema(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InfoF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
