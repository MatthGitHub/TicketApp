...
public class MySystemTray {
     ...
     * @param frame
     */
    private MySystemTray( Main frame)
    {
    this.parent = frame;
      ...
      //acciones del raton sobre el icono en la barra de tareas
        MouseListener mouseListener = new MouseListener() {
            ...
            public void mousePressed(MouseEvent evt) {
                if( evt.getButton() == MouseEvent.BUTTON1 && parent.getExtendedState()==ICONIFIED ){
                        parent.setVisible(true);
                        parent.setExtendedState(NORMAL);
                        System.out.println("Entra al metodo de restaurar ventana en mousePressed");
                        parent.repaint();                
        ...
        ActionListener exitListener = (ActionEvent e) -> {
            Main.getMainFrame().salirPrograma();
        };
        
        //Restaurar aplicacion
        ActionListener restoreListener = (ActionEvent e) -> {
            //si esta minimizado restaura JFrame
            if(parent.getExtendedState()== ICONIFIED){
                parent.setVisible(true);
                parent.setExtendedState(NORMAL);
                parent.repaint();     
                System.out.println("Entra al metodo de restaurar ventana");
                //if(timer!=null) timer.cancel();
            }            
        };
    ...
    parent.addWindowListener(new WindowAdapter(){
        ...
        public void windowIconified(WindowEvent e){
           ...
           System.out.println("Entra al metodo de iconizar ventana");
    ...
    public static MySystemTray getMySystemTray(Main frame){
        if(estaClase == null){
    ...
    public void MensajeTrayIcon(String texto, MessageType tipo)
    {
        ...
        System.out.println("Notificacion: "+texto);
    }
    ...
    /*class MyTimerTask extends TimerTask {
        ...
        { 
            System.out.println("Action background (No hace nada) ");
        }
