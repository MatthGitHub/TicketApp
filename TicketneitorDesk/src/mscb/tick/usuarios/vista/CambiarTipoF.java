 ...
 */
public class CambiarTipoF extends javax.swing.JFrame {
    Main mainFrame;
    private CambiarTipoP pgm;
    private int x;
    private int y;
    ...
    public Image getIconImage() {
        Image retValue = Toolkit.getDefaultToolkit().
                getImage(ClassLoader.getSystemResource("mscb/tick/imagenes/estadoSistema.png"));
     ...
     */
    public CambiarTipoF(Main mainFrame,Usuarios usu) {
        initComponents();
    ...
    private CambiarTipoF() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
    public void CambiarTipoM(Usuarios usu){
        pgm = CambiarTipoP.getPanelPgm(this,usu,mainFrame);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CambiarTipoF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CambiarTipoF().setVisible(true);
            }
        });
    }
