 ...
 */
public class ModificarNotaSalida extends javax.swing.JDialog {
    Main mainFrame;
     ...
     */
    public ModificarNotaSalida(java.awt.Frame parent, boolean modal,Tickets miTick) {
        super(parent, modal);
        initComponents();
    ...
    private ModificarNotaSalida(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Nota Salida", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("SansSerif", 0, 18), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarNotaSalida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModificarNotaSalida dialog = new ModificarNotaSalida(new javax.swing.JFrame(), true);
