 ...
 */
public class ResolucionD extends javax.swing.JDialog {
    private ResolucionP miPanel;
    Main mainFrame;
    ...
    private ResolucionD(JFrame jFrame, boolean b) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResolucionD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ResolucionD dialog = new ResolucionD(new javax.swing.JFrame(), true);
