 ...
 */
public class TransferenciaF extends javax.swing.JFrame {
    Main mainFrame;
    ...
    /**
     * Creates new form TransferenciaF
     */
    public TransferenciaF(Tickets miTick, Main mainFrame) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransferenciaF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransferenciaF().setVisible(true);
            }
        });
    }
