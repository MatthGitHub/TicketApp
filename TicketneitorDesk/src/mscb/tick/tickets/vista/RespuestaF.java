 ...
 */
public class RespuestaF extends javax.swing.JFrame {
    ...
    /**
     * Creates new form RespuestaF
     */
    public RespuestaF(Ticket miTick, Main mainFrame) {
        initComponents();
    ...
    public void RespuestaMeth(Ticket miTick){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RespuestaF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RespuestaF().setVisible(true);
            }
        });
    }
