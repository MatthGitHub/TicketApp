 ...
 */
package ticketneitorupdater.gui.main;
...
import ticketneitorupdater.gui.resources.MenuP;
...
public class Main extends javax.swing.JFrame {
    ...
    private boolean borrarArchivo(){
        File aBorrar = new File("TicketneitorDesk.jar").getAbsoluteFile();
    ...
    private void actualizar(){
        File aqui = new File("TicketneitorDesk.jar").getAbsoluteFile();
        borrarArchivo();
        try {
            copyFile();
            JOptionPane.showMessageDialog(this, "Actualizacion finalizada");
            try {
                Runtime.getRuntime().exec("java -jar TicketneitorDesk.jar");
                System.exit(0);
        ...
        //System.out.println(aqui.getPath());
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder(null, "Actualiza ticketneitor", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Bradley Hand ITC", 1, 24), new java.awt.Color(255, 255, 255)))); // NOI18N
